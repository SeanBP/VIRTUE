...
- **VIRTUE_User_Guide_V3_2_2.pdf** — The full user guide, covering system requirements, the JSON event/model/tour file formats, and how to build the Unity projects.
